...
// ==============================================================
#ifndef __gaussian_filter_mZio__HH__
#define __gaussian_filter_mZio__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(gaussian_filter_mZio) {
    ...
    SC_CTOR(gaussian_filter_mZio):  simcore_mac_8_U ("simcore_mac_8_U") {
