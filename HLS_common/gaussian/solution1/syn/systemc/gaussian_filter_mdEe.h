...
// ==============================================================
#ifndef __gaussian_filter_mdEe__HH__
#define __gaussian_filter_mdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(gaussian_filter_mdEe) {
    ...
    SC_CTOR(gaussian_filter_mdEe):  simcore_mac_1_U ("simcore_mac_1_U") {
