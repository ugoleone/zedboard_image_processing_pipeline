...
// ==============================================================
#ifndef __gaussian_filter_aYie__HH__
#define __gaussian_filter_aYie__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(gaussian_filter_aYie) {
    ...
    SC_CTOR(gaussian_filter_aYie):  simcore_ama_0_U ("simcore_ama_0_U") {
