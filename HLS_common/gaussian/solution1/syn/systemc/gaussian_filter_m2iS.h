...
// ==============================================================
#ifndef __gaussian_filter_m2iS__HH__
#define __gaussian_filter_m2iS__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(gaussian_filter_m2iS) {
    ...
    SC_CTOR(gaussian_filter_m2iS):  simcore_mac_11_U ("simcore_mac_11_U") {
