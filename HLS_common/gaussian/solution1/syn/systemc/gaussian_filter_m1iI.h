...
// ==============================================================
#ifndef __gaussian_filter_m1iI__HH__
#define __gaussian_filter_m1iI__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(gaussian_filter_m1iI) {
    ...
    SC_CTOR(gaussian_filter_m1iI):  simcore_mac_10_U ("simcore_mac_10_U") {
