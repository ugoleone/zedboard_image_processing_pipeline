...
// ==============================================================
#ifndef __gaussian_filter_mXh4__HH__
#define __gaussian_filter_mXh4__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(gaussian_filter_mXh4) {
    ...
    SC_CTOR(gaussian_filter_mXh4):  simcore_mac_7_U ("simcore_mac_7_U") {
