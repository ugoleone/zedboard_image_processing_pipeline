...
// ==============================================================
#ifndef __gaussian_filter_mcud__HH__
#define __gaussian_filter_mcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(gaussian_filter_mcud) {
    ...
    SC_CTOR(gaussian_filter_mcud):  simcore_mac_0_U ("simcore_mac_0_U") {
