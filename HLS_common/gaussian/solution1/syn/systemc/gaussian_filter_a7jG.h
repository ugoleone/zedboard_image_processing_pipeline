...
// ==============================================================
#ifndef __gaussian_filter_a7jG__HH__
#define __gaussian_filter_a7jG__HH__
...
template<
    ...
    int din3_WIDTH,
    int dout_WIDTH>
SC_MODULE(gaussian_filter_a7jG) {
    ...
    SC_CTOR(gaussian_filter_a7jG):  simcore_ama_1_U ("simcore_ama_1_U") {
