...
// ==============================================================
#ifndef __gaussian_filter_mVhK__HH__
#define __gaussian_filter_mVhK__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(gaussian_filter_mVhK) {
    ...
    SC_CTOR(gaussian_filter_mVhK):  simcore_mac_5_U ("simcore_mac_5_U") {
