...
// ==============================================================
#ifndef __gaussian_filter_mThq__HH__
#define __gaussian_filter_mThq__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(gaussian_filter_mThq) {
    ...
    SC_CTOR(gaussian_filter_mThq):  simcore_mac_3_U ("simcore_mac_3_U") {
