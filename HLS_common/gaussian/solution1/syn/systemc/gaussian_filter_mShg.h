...
// ==============================================================
#ifndef __gaussian_filter_mShg__HH__
#define __gaussian_filter_mShg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(gaussian_filter_mShg) {
    ...
    SC_CTOR(gaussian_filter_mShg):  simcore_mac_2_U ("simcore_mac_2_U") {
