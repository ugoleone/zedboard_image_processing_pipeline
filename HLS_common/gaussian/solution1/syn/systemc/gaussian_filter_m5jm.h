...
// ==============================================================
#ifndef __gaussian_filter_m5jm__HH__
#define __gaussian_filter_m5jm__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(gaussian_filter_m5jm) {
    ...
    SC_CTOR(gaussian_filter_m5jm):  simcore_mac_14_U ("simcore_mac_14_U") {
