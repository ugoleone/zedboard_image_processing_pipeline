...
// ==============================================================
#ifndef __gaussian_filter_mUhA__HH__
#define __gaussian_filter_mUhA__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(gaussian_filter_mUhA) {
    ...
    SC_CTOR(gaussian_filter_mUhA):  simcore_mac_4_U ("simcore_mac_4_U") {
