...
// ==============================================================
#ifndef __gaussian_filter_m0iy__HH__
#define __gaussian_filter_m0iy__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(gaussian_filter_m0iy) {
    ...
    SC_CTOR(gaussian_filter_m0iy):  simcore_mac_9_U ("simcore_mac_9_U") {
