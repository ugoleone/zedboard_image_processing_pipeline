...
AXIvideo2Mat::AXIvideo2Mat(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sc_trace(mVcdFile, tmp_52_reg_450, "tmp_52_reg_450");
    sc_trace(mVcdFile, tmp_53_reg_455, "tmp_53_reg_455");
...
void AXIvideo2Mat::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp1_stage0.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, exitcond_i_fu_344_p2.read()) && esl_seteq<1,1,1>(ap_block_pp1_stage0_11001.read(), ap_const_boolean_0))) {
        tmp_52_reg_450 = ap_phi_mux_p_Val2_s_phi_fu_264_p4.read().range(15, 8);
        tmp_53_reg_455 = ap_phi_mux_p_Val2_s_phi_fu_264_p4.read().range(23, 16);
...
void AXIvideo2Mat::thread_img_data_stream_1_V_din() {
    img_data_stream_1_V_din = tmp_52_reg_450.read();
}
...
void AXIvideo2Mat::thread_img_data_stream_2_V_din() {
    img_data_stream_2_V_din = tmp_53_reg_455.read();
}
