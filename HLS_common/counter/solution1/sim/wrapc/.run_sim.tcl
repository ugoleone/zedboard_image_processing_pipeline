...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "contatore_no_io.autotvin.dat"
	set constFileTvOut       "contatore_no_io.autotvout.dat"
	set constFileHdlTvIn     "contatore_no_io.autohdltvin.dat"
	set constFileHdlTvOut    "contatore_no_io.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
