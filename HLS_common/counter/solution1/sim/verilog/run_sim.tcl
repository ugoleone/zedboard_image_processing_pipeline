...
if {[file isfile contatore_no_io.autotvin.dat]} {
	file delete -force contatore_no_io.autotvin.dat
}

if {[file isfile contatore_no_io.autotvout.dat]} {
	file delete -force contatore_no_io.autotvout.dat
}
