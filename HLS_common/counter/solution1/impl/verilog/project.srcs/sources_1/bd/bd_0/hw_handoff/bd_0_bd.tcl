...
proc create_root_design { parentCell } {
  ...
  set led_output_V [ create_bd_port -dir O -from 0 -to 0 -type data led_output_V ]

  # Create instance: hls_inst, and set properties
  set hls_inst [ create_bd_cell -type ip -vlnv Ugo:hls:contatore_no_io:1.3 hls_inst ]
  ...
  connect_bd_net -net hls_inst_led_output_V [get_bd_ports led_output_V] [get_bd_pins hls_inst/led_output_V]
