...
output   ap_idle;
output   ap_ready;
output  [9:0] img0_rows_V_out_din;
input   img0_rows_V_out_full_n;
output   img0_rows_V_out_write;
output  [10:0] img0_cols_V_out_din;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start == 1'b0) | (img0_cols_V_out_full_n == 1'b0) | (img0_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (img0_cols_V_out_full_n == 1'b0) | (img0_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1 = ((ap_start == 1'b0) | (img0_cols_V_out_full_n == 1'b0) | (img0_rows_V_out_full_n == 1'b0) | (ap_done_reg == 1'b1));
end

assign img0_cols_V_out_din = 11'd640;

assign img0_rows_V_out_din = 10'd480;
