...
reg   [7:0] tmp_reg_445;
reg   [7:0] tmp_28_reg_450;
reg   [7:0] tmp_29_reg_455;
reg    ap_block_state8;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_344_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        tmp_28_reg_450 <= {{ap_phi_mux_p_Val2_s_phi_fu_264_p4[15:8]}};
        tmp_29_reg_455 <= {{ap_phi_mux_p_Val2_s_phi_fu_264_p4[23:16]}};
...
assign img_data_stream_1_V_din = tmp_28_reg_450;

assign img_data_stream_2_V_din = tmp_29_reg_455;
