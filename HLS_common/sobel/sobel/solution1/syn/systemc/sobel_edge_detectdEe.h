...
// ==============================================================
#ifndef __sobel_edge_detectdEe__HH__
#define __sobel_edge_detectdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sobel_edge_detectdEe) {
    ...
    SC_CTOR(sobel_edge_detectdEe):  simcore_mac_1_U ("simcore_mac_1_U") {
