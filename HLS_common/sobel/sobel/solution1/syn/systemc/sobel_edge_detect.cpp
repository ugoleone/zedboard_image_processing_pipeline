...
const sc_lv<24> sobel_edge_detect::ap_const_lv24_0 = "000000000000000000000000";
const sc_lv<3> sobel_edge_detect::ap_const_lv3_0 = "000";
const sc_lv<1> sobel_edge_detect::ap_const_lv1_0 = "0";
const sc_logic sobel_edge_detect::ap_const_logic_1 = sc_dt::Log_1;
const sc_logic sobel_edge_detect::ap_const_logic_0 = sc_dt::Log_0;
const sc_lv<2> sobel_edge_detect::ap_const_lv2_0 = "00";
const sc_lv<2> sobel_edge_detect::ap_const_lv2_1 = "1";
const bool sobel_edge_detect::ap_const_boolean_1 = true;

sobel_edge_detect::sobel_edge_detect(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    apTFilenSS << "sobel_edge_detect_sc_trace_" << apTFileNum ++;
    ...
    mHdltvinHandle.open("sobel_edge_detect.hdltvin.dat");
    mHdltvoutHandle.open("sobel_edge_detect.hdltvout.dat");
}

sobel_edge_detect::~sobel_edge_detect() {
    if (mVcdFile) 
...
void sobel_edge_detect::thread_ap_var_for_const0() {
    ap_var_for_const0 = ap_const_logic_1;
}

void sobel_edge_detect::thread_ap_clk_no_reset_() {
...
void sobel_edge_detect::thread_AXIvideo2Mat_U0_ap_continue() {
    AXIvideo2Mat_U0_ap_continue = ap_const_logic_1;
}

void sobel_edge_detect::thread_AXIvideo2Mat_U0_ap_start() {
    AXIvideo2Mat_U0_ap_start = (ap_start.read() & (ap_sync_reg_AXIvideo2Mat_U0_ap_ready.read() ^ 
  ap_const_logic_1));
}

void sobel_edge_detect::thread_Block_proc_U0_ap_continue() {
    Block_proc_U0_ap_continue = ap_const_logic_1;
}

void sobel_edge_detect::thread_Block_proc_U0_ap_start() {
    Block_proc_U0_ap_start = (ap_start.read() & (ap_sync_reg_Block_proc_U0_ap_ready.read() ^ 
  ap_const_logic_1));
}

void sobel_edge_detect::thread_Block_proc_U0_start_full_n() {
    Block_proc_U0_start_full_n = ap_const_logic_1;
}

void sobel_edge_detect::thread_Block_proc_U0_start_write() {
    Block_proc_U0_start_write = ap_const_logic_0;
}

void sobel_edge_detect::thread_CvtColor_1_U0_ap_continue() {
    CvtColor_1_U0_ap_continue = ap_const_logic_1;
}

void sobel_edge_detect::thread_CvtColor_1_U0_ap_start() {
    CvtColor_1_U0_ap_start = start_for_CvtColor_1_U0_empty_n.read();
}

void sobel_edge_detect::thread_CvtColor_U0_ap_continue() {
    CvtColor_U0_ap_continue = ap_const_logic_1;
}

void sobel_edge_detect::thread_CvtColor_U0_ap_start() {
    CvtColor_U0_ap_start = start_for_CvtColor_U0_empty_n.read();
}

void sobel_edge_detect::thread_Mat2AXIvideo_U0_ap_continue() {
    Mat2AXIvideo_U0_ap_continue = ap_const_logic_1;
}

void sobel_edge_detect::thread_Mat2AXIvideo_U0_ap_start() {
    Mat2AXIvideo_U0_ap_start = start_for_Mat2AXIvideo_U0_empty_n.read();
}

void sobel_edge_detect::thread_Mat2AXIvideo_U0_start_full_n() {
    Mat2AXIvideo_U0_start_full_n = ap_const_logic_1;
}

void sobel_edge_detect::thread_Mat2AXIvideo_U0_start_write() {
    Mat2AXIvideo_U0_start_write = ap_const_logic_0;
}

void sobel_edge_detect::thread_Sobel_U0_ap_continue() {
    Sobel_U0_ap_continue = ap_const_logic_1;
}

void sobel_edge_detect::thread_Sobel_U0_ap_start() {
    Sobel_U0_ap_start = start_for_Sobel_U0_empty_n.read();
}

void sobel_edge_detect::thread_ap_done() {
    ap_done = Mat2AXIvideo_U0_ap_done.read();
}

void sobel_edge_detect::thread_ap_idle() {
    ap_idle = (Block_proc_U0_ap_idle.read() & AXIvideo2Mat_U0_ap_idle.read() & CvtColor_U0_ap_idle.read() & Sobel_U0_ap_idle.read() & CvtColor_1_U0_ap_idle.read() & Mat2AXIvideo_U0_ap_idle.read());
}

void sobel_edge_detect::thread_ap_ready() {
    ap_ready = ap_sync_ready.read();
}

void sobel_edge_detect::thread_ap_rst_n_inv() {
    ap_rst_n_inv =  (sc_logic) (~ap_rst_n.read());
}

void sobel_edge_detect::thread_ap_sync_AXIvideo2Mat_U0_ap_ready() {
    ap_sync_AXIvideo2Mat_U0_ap_ready = (AXIvideo2Mat_U0_ap_ready.read() | ap_sync_reg_AXIvideo2Mat_U0_ap_ready.read());
}

void sobel_edge_detect::thread_ap_sync_Block_proc_U0_ap_ready() {
    ap_sync_Block_proc_U0_ap_ready = (Block_proc_U0_ap_ready.read() | ap_sync_reg_Block_proc_U0_ap_ready.read());
}

void sobel_edge_detect::thread_ap_sync_continue() {
    ap_sync_continue = ap_const_logic_1;
}

void sobel_edge_detect::thread_ap_sync_done() {
    ap_sync_done = Mat2AXIvideo_U0_ap_done.read();
}

void sobel_edge_detect::thread_ap_sync_ready() {
    ap_sync_ready = (ap_sync_Block_proc_U0_ap_ready.read() & ap_sync_AXIvideo2Mat_U0_ap_ready.read());
}

void sobel_edge_detect::thread_start_for_CvtColor_1_U0_din() {
    start_for_CvtColor_1_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void sobel_edge_detect::thread_start_for_CvtColor_U0_din() {
    start_for_CvtColor_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void sobel_edge_detect::thread_start_for_Mat2AXIvideo_U0_din() {
    start_for_Mat2AXIvideo_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void sobel_edge_detect::thread_start_for_Sobel_U0_din() {
    start_for_Sobel_U0_din =  (sc_lv<1>) (ap_const_logic_1);
}

void sobel_edge_detect::thread_stream_in_TREADY() {
    stream_in_TREADY = AXIvideo2Mat_U0_stream_in_TREADY.read();
}

void sobel_edge_detect::thread_stream_out_TDATA() {
    stream_out_TDATA = Mat2AXIvideo_U0_stream_out_TDATA.read();
}

void sobel_edge_detect::thread_stream_out_TDEST() {
    stream_out_TDEST = Mat2AXIvideo_U0_stream_out_TDEST.read();
}

void sobel_edge_detect::thread_stream_out_TID() {
    stream_out_TID = Mat2AXIvideo_U0_stream_out_TID.read();
}

void sobel_edge_detect::thread_stream_out_TKEEP() {
    stream_out_TKEEP = Mat2AXIvideo_U0_stream_out_TKEEP.read();
}

void sobel_edge_detect::thread_stream_out_TLAST() {
    stream_out_TLAST = Mat2AXIvideo_U0_stream_out_TLAST.read();
}

void sobel_edge_detect::thread_stream_out_TSTRB() {
    stream_out_TSTRB = Mat2AXIvideo_U0_stream_out_TSTRB.read();
}

void sobel_edge_detect::thread_stream_out_TUSER() {
    stream_out_TUSER = Mat2AXIvideo_U0_stream_out_TUSER.read();
}

void sobel_edge_detect::thread_stream_out_TVALID() {
    stream_out_TVALID = Mat2AXIvideo_U0_stream_out_TVALID.read();
}

void sobel_edge_detect::thread_hdltv_gen() {
