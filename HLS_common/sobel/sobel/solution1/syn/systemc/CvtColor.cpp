...
CvtColor::CvtColor(sc_module_name name) : sc_module(name), mVcdFile(0) {
    sobel_edge_detectbkb_U17 = new sobel_edge_detectbkb<1,1,22,8,29>("sobel_edge_detectbkb_U17");
    sobel_edge_detectbkb_U17->din0(r_V_i_i_fu_277_p0);
    sobel_edge_detectbkb_U17->din1(r_V_i_i_fu_277_p1);
    sobel_edge_detectbkb_U17->dout(r_V_i_i_fu_277_p2);
    sobel_edge_detectcud_U18 = new sobel_edge_detectcud<1,1,23,8,29,30>("sobel_edge_detectcud_U18");
    sobel_edge_detectcud_U18->din0(grp_fu_283_p0);
    sobel_edge_detectcud_U18->din1(grp_fu_283_p1);
    sobel_edge_detectcud_U18->din2(grp_fu_283_p2);
    sobel_edge_detectcud_U18->dout(grp_fu_283_p3);
    sobel_edge_detectdEe_U19 = new sobel_edge_detectdEe<1,1,20,8,29,29>("sobel_edge_detectdEe_U19");
    sobel_edge_detectdEe_U19->din0(grp_fu_294_p0);
    sobel_edge_detectdEe_U19->din1(grp_fu_294_p1);
    sobel_edge_detectdEe_U19->din2(r_V_i_i_reg_340);
    sobel_edge_detectdEe_U19->dout(grp_fu_294_p3);
    ...
    sensitive << ( tmp_20_i_reg_321 );
    sensitive << ( ap_enable_reg_pp0_iter3 );
    sensitive << ( tmp_20_i_reg_321_pp0_iter2_reg );
    ...
    sensitive << ( tmp_86_fu_255_p3 );
    sensitive << ( rev_fu_249_p2 );

    SC_METHOD(thread_grp_fu_283_p0);
    sensitive << ( ap_block_pp0_stage0 );
    sensitive << ( tmp_20_i_reg_321_pp0_iter1_reg );
    sensitive << ( ap_enable_reg_pp0_iter2 );
    ...
    SC_METHOD(thread_p_Val2_14_fu_216_p4);
    sensitive << ( grp_fu_283_p3 );

    SC_METHOD(thread_p_Val2_15_fu_236_p2);
    sensitive << ( tmp_5_i_i_i_cast_i_fu_232_p1 );
    sensitive << ( p_Val2_14_fu_216_p4 );

    SC_METHOD(thread_p_Val2_s_fu_269_p3);
    sensitive << ( p_Val2_15_fu_236_p2 );
    ...
    SC_METHOD(thread_tmp_20_i_fu_192_p2);
    sensitive << ( ap_CS_fsm_pp0_stage0 );
    ...
    SC_METHOD(thread_tmp_5_i_i_i_cast_i_fu_232_p1);
    sensitive << ( tmp_fu_225_p3 );

    SC_METHOD(thread_tmp_85_fu_242_p3);
    sensitive << ( grp_fu_283_p3 );

    SC_METHOD(thread_tmp_86_fu_255_p3);
    sensitive << ( p_Val2_15_fu_236_p2 );
    ...
    sc_trace(mVcdFile, tmp_20_i_reg_321, "tmp_20_i_reg_321");
    ...
    sc_trace(mVcdFile, tmp_20_i_reg_321_pp0_iter2_reg, "tmp_20_i_reg_321_pp0_iter2_reg");
    ...
    sc_trace(mVcdFile, tmp_20_i_fu_192_p2, "tmp_20_i_fu_192_p2");
    ...
    sc_trace(mVcdFile, tmp_20_i_reg_321_pp0_iter1_reg, "tmp_20_i_reg_321_pp0_iter1_reg");
    sc_trace(mVcdFile, j_fu_197_p2, "j_fu_197_p2");
    sc_trace(mVcdFile, ap_enable_reg_pp0_iter0, "ap_enable_reg_pp0_iter0");
    sc_trace(mVcdFile, tmp_89_reg_330, "tmp_89_reg_330");
    sc_trace(mVcdFile, tmp_90_reg_335, "tmp_90_reg_335");
    ...
    sc_trace(mVcdFile, tmp_5_i_i_i_cast_i_fu_232_p1, "tmp_5_i_i_i_cast_i_fu_232_p1");
    sc_trace(mVcdFile, p_Val2_14_fu_216_p4, "p_Val2_14_fu_216_p4");
    sc_trace(mVcdFile, tmp_85_fu_242_p3, "tmp_85_fu_242_p3");
    sc_trace(mVcdFile, p_Val2_15_fu_236_p2, "p_Val2_15_fu_236_p2");
    sc_trace(mVcdFile, tmp_86_fu_255_p3, "tmp_86_fu_255_p3");
...
CvtColor::~CvtColor() {
    ...
    delete sobel_edge_detectbkb_U17;
    delete sobel_edge_detectcud_U18;
    delete sobel_edge_detectdEe_U19;
}
...
void CvtColor::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
         ...
         esl_seteq<1,1,1>(ap_const_lv1_1, tmp_20_i_fu_192_p2.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0) && esl_seteq<1,1,1>(ap_const_lv1_1, tmp_20_i_reg_321_pp0_iter1_reg.read()))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(tmp_20_i_reg_321.read(), ap_const_lv1_1) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        r_V_i_i_reg_340 = r_V_i_i_fu_277_p2.read();
        tmp_89_reg_330 = p_src_data_stream_1_V_dout.read();
        tmp_90_reg_335 = p_src_data_stream_2_V_dout.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0))) {
        tmp_20_i_reg_321 = tmp_20_i_fu_192_p2.read();
        tmp_20_i_reg_321_pp0_iter1_reg = tmp_20_i_reg_321.read();
    }
    if (esl_seteq<1,1,1>(ap_block_pp0_stage0_11001.read(), ap_const_boolean_0)) {
        tmp_20_i_reg_321_pp0_iter2_reg = tmp_20_i_reg_321_pp0_iter1_reg.read();
    }
}
...
void CvtColor::thread_ap_block_pp0_stage0_01001() {
  ...
  ((esl_seteq<1,1,1>(tmp_20_i_reg_321.read(), ap_const_lv1_1) && 
  ...
  ((esl_seteq<1,1,1>(ap_const_lv1_1, tmp_20_i_reg_321_pp0_iter2_reg.read()) && 
...
void CvtColor::thread_ap_block_state4_pp0_stage0_iter1() {
    ap_block_state4_pp0_stage0_iter1 = ((esl_seteq<1,1,1>(tmp_20_i_reg_321.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(ap_const_logic_0, p_src_data_stream_0_V_empty_n.read())) || (esl_seteq<1,1,1>(tmp_20_i_reg_321.read(), ap_const_lv1_1) && 
  esl_seteq<1,1,1>(ap_const_logic_0, p_src_data_stream_1_V_empty_n.read())) || (esl_seteq<1,1,1>(tmp_20_i_reg_321.read(), ap_const_lv1_1) && 
...
void CvtColor::thread_ap_block_state6_pp0_stage0_iter3() {
    ap_block_state6_pp0_stage0_iter3 = ((esl_seteq<1,1,1>(ap_const_lv1_1, tmp_20_i_reg_321_pp0_iter2_reg.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, p_dst_data_stream_0_V_full_n.read())) || (esl_seteq<1,1,1>(ap_const_lv1_1, tmp_20_i_reg_321_pp0_iter2_reg.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, p_dst_data_stream_1_V_full_n.read())) || (esl_seteq<1,1,1>(ap_const_lv1_1, tmp_20_i_reg_321_pp0_iter2_reg.read()) && 
  esl_seteq<1,1,1>(ap_const_logic_0, p_dst_data_stream_2_V_full_n.read())));
}

void CvtColor::thread_ap_condition_pp0_exit_iter0_state3() {
    if (esl_seteq<1,1,1>(tmp_20_i_fu_192_p2.read(), ap_const_lv1_0)) {
...
void CvtColor::thread_deleted_zeros_fu_263_p2() {
    deleted_zeros_fu_263_p2 = (tmp_86_fu_255_p3.read() | rev_fu_249_p2.read());
}
...
void CvtColor::thread_grp_fu_283_p10() {
    grp_fu_283_p10 = esl_zext<30,8>(tmp_89_reg_330.read());
}
...
void CvtColor::thread_grp_fu_294_p10() {
    grp_fu_294_p10 = esl_zext<28,8>(tmp_90_reg_335.read());
}
...
void CvtColor::thread_p_Val2_14_fu_216_p4() {
    p_Val2_14_fu_216_p4 = grp_fu_283_p3.read().range(29, 22);
}

void CvtColor::thread_p_Val2_15_fu_236_p2() {
    p_Val2_15_fu_236_p2 = (!tmp_5_i_i_i_cast_i_fu_232_p1.read().is_01() || !p_Val2_14_fu_216_p4.read().is_01())? sc_lv<8>(): (sc_biguint<8>(tmp_5_i_i_i_cast_i_fu_232_p1.read()) + sc_biguint<8>(p_Val2_14_fu_216_p4.read()));
}

void CvtColor::thread_p_Val2_s_fu_269_p3() {
    p_Val2_s_fu_269_p3 = (!deleted_zeros_fu_263_p2.read()[0].is_01())? sc_lv<8>(): ((deleted_zeros_fu_263_p2.read()[0].to_bool())? p_Val2_15_fu_236_p2.read(): ap_const_lv8_FF);
}
...
void CvtColor::thread_rev_fu_249_p2() {
    rev_fu_249_p2 = (tmp_85_fu_242_p3.read() ^ ap_const_lv1_1);
}
...
void CvtColor::thread_tmp_20_i_fu_192_p2() {
    tmp_20_i_fu_192_p2 = (!j_cast_cast_i_fu_188_p1.read().is_01() || !p_src_cols_V_read_reg_302.read().is_01())? sc_lv<1>(): (sc_bigint<11>(j_cast_cast_i_fu_188_p1.read()) < sc_bigint<11>(p_src_cols_V_read_reg_302.read()));
}

void CvtColor::thread_tmp_5_i_i_i_cast_i_fu_232_p1() {
    tmp_5_i_i_i_cast_i_fu_232_p1 = esl_zext<8,1>(tmp_fu_225_p3.read());
}

void CvtColor::thread_tmp_85_fu_242_p3() {
    tmp_85_fu_242_p3 = grp_fu_283_p3.read().range(29, 29);
}

void CvtColor::thread_tmp_86_fu_255_p3() {
    tmp_86_fu_255_p3 = p_Val2_15_fu_236_p2.read().range(7, 7);
}
...
void CvtColor::thread_ap_NS_fsm() {
  ...
  esl_seteq<1,1,1>(ap_block_pp0_stage0_subdone.read(), ap_const_boolean_0) && 
  esl_seteq<1,1,1>(tmp_20_i_fu_192_p2.read(), ap_const_lv1_0) && 
