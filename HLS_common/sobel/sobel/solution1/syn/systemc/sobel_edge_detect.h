...
#ifndef _sobel_edge_detect_HH_
#define _sobel_edge_detect_HH_
...
struct sobel_edge_detect : public sc_module {
    ...
    // Module declarations
    sobel_edge_detect(sc_module_name name);
    SC_HAS_PROCESS(sobel_edge_detect);
