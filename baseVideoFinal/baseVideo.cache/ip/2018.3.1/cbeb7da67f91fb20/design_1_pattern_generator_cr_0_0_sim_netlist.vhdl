...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Loop_loop_height_pro is
  ...
  signal tmp_2_fu_145_p2 : STD_LOGIC;
  signal \tmp_2_reg_188[0]_i_1_n_0\ : STD_LOGIC;
  signal tmp_2_reg_188_pp0_iter1_reg : STD_LOGIC;
  signal \tmp_2_reg_188_pp0_iter1_reg[0]_i_1_n_0\ : STD_LOGIC;
  signal \tmp_2_reg_188_reg_n_0_[0]\ : STD_LOGIC;
  signal \tmp_fu_133_p2__11\ : STD_LOGIC;
...
\tmp_2_reg_188[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FB08"
    )
        port map (
...
\tmp_2_reg_188_pp0_iter1_reg[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\tmp_2_reg_188_pp0_iter1_reg_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => '1',
...
\tmp_2_reg_188_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => ap_clk,
      CE => '1',
...
begin
  ap_done <= \^ap_ready\;
  ap_ready <= \^ap_ready\;
  outputStream_TDATA(23) <= \<const1>\;
  outputStream_TDATA(22) <= \<const1>\;
  outputStream_TDATA(21) <= \<const1>\;
  outputStream_TDATA(20) <= \<const1>\;
  outputStream_TDATA(19) <= \<const1>\;
  outputStream_TDATA(18) <= \<const1>\;
  outputStream_TDATA(17) <= \<const1>\;
  outputStream_TDATA(16) <= \<const1>\;
  outputStream_TDATA(15) <= \<const1>\;
  outputStream_TDATA(14) <= \<const1>\;
  outputStream_TDATA(13) <= \<const1>\;
  outputStream_TDATA(12) <= \<const1>\;
  outputStream_TDATA(11) <= \<const1>\;
  outputStream_TDATA(10) <= \<const1>\;
  outputStream_TDATA(9) <= \<const1>\;
  outputStream_TDATA(8) <= \<const1>\;
  outputStream_TDATA(7) <= \<const1>\;
  outputStream_TDATA(6) <= \<const1>\;
  outputStream_TDATA(5) <= \<const1>\;
  outputStream_TDATA(4) <= \<const1>\;
  outputStream_TDATA(3) <= \<const1>\;
  outputStream_TDATA(2) <= \<const1>\;
  outputStream_TDATA(1) <= \<const1>\;
  outputStream_TDATA(0) <= \<const1>\;
