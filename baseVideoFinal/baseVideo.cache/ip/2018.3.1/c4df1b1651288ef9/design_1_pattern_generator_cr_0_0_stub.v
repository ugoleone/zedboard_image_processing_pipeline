...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ap_clk, ap_rst_n, ap_start, ap_done, ap_idle, 
  ...
  outputStream_TVALID, outputStream_TREADY, outputStream_TDATA, outputStream_TDEST, 
  outputStream_TKEEP, outputStream_TSTRB, outputStream_TUSER, outputStream_TLAST, 
  outputStream_TID)
/* synthesis syn_black_box black_box_pad_pin="ap_clk,ap_rst_n,ap_start,ap_done,ap_idle,ap_ready,inStream_V_V_TVALID,inStream_V_V_TREADY,inStream_V_V_TDATA[7:0],outputStream_TVALID,outputStream_TREADY,outputStream_TDATA[23:0],outputStream_TDEST[0:0],outputStream_TKEEP[2:0],outputStream_TSTRB[2:0],outputStream_TUSER[0:0],outputStream_TLAST[0:0],outputStream_TID[0:0]" */;
  input ap_clk;
  input ap_rst_n;
  input ap_start;
  output ap_done;
