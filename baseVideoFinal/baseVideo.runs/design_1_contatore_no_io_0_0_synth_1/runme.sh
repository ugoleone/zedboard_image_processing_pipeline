...
HD_PWD='C:/Users/ugo/Desktop/baseVideo/baseVideo.runs/design_1_contatore_no_io_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_contatore_no_io_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_contatore_no_io_0_0.tcl
